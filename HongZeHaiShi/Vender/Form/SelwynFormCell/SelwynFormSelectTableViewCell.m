...
//    self.imageV.center = centerPoint;
    ...
    self.textView.frame = CGRectMake(TitleWidth + 2*EdgeMarin, EdgeMarin, Main_Screen_Width - (TitleWidth + 2*EdgeMarin + 30),  MAX(TitleHeight, newHeight - 2*EdgeMarin));
}

#pragma mark -- cell height
+ (CGFloat)cellHeightWithItem:(SelwynFormItem *)item{
    
    CGSize detailSize = [SelwynFormHandle getSizeWithString:item.formDetail Font:Font(TitleFont) maxSize:CGSizeMake(Main_Screen_Width - TitleWidth - 2*EdgeMarin - 30, MAXFLOAT)];
