...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    } else if (item.formCellType == SelwynFormCellTypeInputAndImage){
        
        static NSString *cell_id = @"inputAndImageCell_id";
        
        ZLFormInputAndImageTableViewCell *cell = [tableView formInputAndImageCellWithId:cell_id];
        cell.formItem = item;
        cell.formInputAndImageCompletion = ^(NSString *text) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (item.formCellType == SelwynFormCellTypeTextViewInput) {
        ...
        return [ZLFormInputAndImageTableViewCell cellHeightWithItem:item];
