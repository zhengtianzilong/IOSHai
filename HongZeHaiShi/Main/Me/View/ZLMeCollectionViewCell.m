...
@interface ZLMeCollectionViewCell ()
...
@implementation ZLMeCollectionViewCell
...
- (void)layoutSubviews{
    ...
    [self.customBtn setImagePosition:LXMImagePositionTop spacing:10];
...
-(void)setModel:(ZLMeCollectionModel *)model{
